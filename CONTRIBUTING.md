# Contributing to Local Service Site Builder

Local Service Site Builder is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: A local-service website planner for service pages, quote forms, trust sections, local SEO, and launch-ready structure.
